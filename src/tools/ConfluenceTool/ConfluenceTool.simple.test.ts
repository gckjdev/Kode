...
describe('ConfluenceTool - Basic Functionality', () => {
  ...
  describe('Rendering Methods', () => {
    it('should render tool use message correctly for get operation', () => {
    ...
    it('should render tool use message correctly for get by title', () => {
      const input = { 
        operation: 'get' as const, 
        pageTitle: 'Test Page',
        spaceKey: 'DOCS'
    ...
    it('should render tool use message correctly for create operation', () => {
      const input = { 
        operation: 'create' as const, 
        title: 'New Page',
        spaceKey: 'DOCS'
    ...
    it('should render tool use message correctly for update operation', () => {
      const input = { operation: 'update' as const, pageId: '123456' }
      const message = ConfluenceTool.renderToolUseMessage(input)
      expect(message).toBe('Updating Confluence page 123456')
    })

    it('should render tool use message correctly for search operation', () => {
      const input = { 
        operation: 'search' as const, 
        query: 'documentation',
        searchSpace: 'DOCS'
    ...
    it('should render tool use message correctly for list operation', () => {
      const input = { operation: 'list' as const, spaceKey: 'DOCS' }
      const message = ConfluenceTool.renderToolUseMessage(input)
      expect(message).toBe('Listing content in Confluence space DOCS')
    })

    it('should render tool use message correctly for spaces operation', () => {
      const input = { operation: 'spaces' as const }
      const message = ConfluenceTool.renderToolUseMessage(input)
      expect(message).toBe('Listing Confluence spaces')
    })

    it('should render tool use message correctly for attachments operation', () => {
  ...
  describe('Constitutional Compliance Validation', () => {
    it('should follow First Principles Engineering', () => {
      // Tool should have clear, justified structure
      expect(ConfluenceTool.name).toBe('confluence') // Simple, clear naming
      expect(ConfluenceTool.isReadOnly()).toBe(false) // Correctly identifies as write tool
      expect(ConfluenceTool.needsPermissions()).toBe(true) // Security-conscious
    })

    it('should provide Empirical Validation capabilities', () => {
      // Tool should be testable and observable
      expect(typeof ConfluenceTool.renderResultForAssistant).toBe('function')
      expect(typeof ConfluenceTool.renderToolResultMessage).toBe('function')
    ...
    it('should maintain Simplicity and Minimalism', () => {
      // Tool should have focused responsibility
      expect(ConfluenceTool.name).toBe('confluence') // Single responsibility
      expect(ConfluenceTool.userFacingName()).toBe('Confluence') // Clear user interface
      
      // Schema should be well-defined but not over-complex
    ...
    it('should support Autonomous Problem Solving', () => {
      // Tool should provide clear error messages for self-diagnosis
      const errorOutput = { 
        operation: 'get', 
        success: false, 
      ...
      expect(result).toContain('.kode.json') // Provides actionable guidance
    })

    it('should demonstrate Tool Mastery and Integration', () => {
      // Tool should integrate seamlessly with Kode ecosystem
      expect(ConfluenceTool.isConcurrencySafe()).toBe(true) // Safe for parallel execution
      expect(ConfluenceTool.needsPermissions()).toBe(true) // Respects permission system
      
      // Should have comprehensive operation support
      const operations = ConfluenceTool.inputSchema.shape.operation._def.values
      expect(operations.length).toBeGreaterThan(5) // Rich functionality
    })
  })
